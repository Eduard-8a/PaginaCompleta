...
export default function EditarVenta() {
    ...
    if (loading) {
        return <p className="text-center mt-5" style={{ color: "#800080" }}>Cargando datos de la venta...</p>;
    }

    return (
        <div className="container mt-5">
            <h2 className="text-center mb-4" style={{ color: "#800080" }}>Editar Venta</h2>
            <form onSubmit={handleEditVenta} className="p-4 rounded-4 shadow-lg col-md-6 mx-auto" style={{ backgroundColor: "#f3e5f5" }}>
                <div className="mb-3">
